  ...
  const navigate=useNavigate();
   const submithandle=(e)=>{
    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-white dark:border-">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" onSubmit={submithandle}>
            <div>
              <label
                htmlFor="email"
                className="block mb-2 text-sm font-medium text- dark:text-black"
              >
                Your email
              </label>
              <input
            ...
            <button
              type="submit"
              className="w-full text-black bg-cyan-300 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Sign in
            </button>
